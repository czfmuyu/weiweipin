...
!function() {
    ...
    var i = function(o) {
        wx.getLocation({
            type: "wgs84",
            success: function(t) {
                v.lat = t.latitude, v.lng = t.longitude, p(o, "location", "location");
            },
            fail: function() {}
        });
    }, o = function(o) {
        wx.getSetting({
            success: function(t) {
                t.authSetting["scope.userLocation"] && i(o), t.authSetting["scope.userInfo"] && s(o, function(t) {
                    o.aldpush_login_data = t, p(o, "user_info", "userinfo");
                });
            }
        });
    }, s = function(t, o) {
        ...
        wx.login({
            success: function(t) {
                t.code ? (v.jscode = t.code, wx.getUserInfo({
                    ...
                    fail: function(t) {
                        p(t, "user_info_close", "user_info_close");
                    }
                })) : v.jscode = 0;
            }
        });
    ...
    function u(t) {
        ...
        this.isShow = !0, h.is_sendEvent && (o = this, wx.onAccelerometerChange(function(t) {
            o.isShow && 1 < t.x && 1 < t.y && 3 <= (n += 1) && (w = !0, p(o, "yyy", "postevent"));
        })), this.aldpush_showOptions = void 0 !== t ? t : {}, v.st = Date.now();
    }
    function g() {
        this.isShow = !1, p(this, "app", "hide"), n = 0;
    }
    function _(t) {
        var o = this;
    ...
    function m(t) {
        void 0 !== t && (this.options = t), v.pp = this.__route__, e = this.__route__, p(getApp(), "page", "hide");
    }
    function x(t, o) {
    ...
    function S(t) {
        ...
        s(o, function(t) {
            o.aldpush_login_data = t, p(o, "user_info", "userinfo"), wx.setStorageSync("isShowClick", "false"), 
            o.setData({
                is_showHideBtn: !0,
                isShowClick: "false"
            });
        }), h.is_Location && i(o), p(o, "fpage", "clickform");
    }
    function k(t) {
        v.ppx = t.detail.target.offsetLeft, v.ppy = t.detail.target.offsetTop, v.fid = t.detail.formId, 
        this.setData({
            is_showHideBtn: !0
        }), p(this, "fhpage", "hideclickform");
    }
    function b(t, o) {
        var e = "", n = arguments;
        if (t || (t = n), t) {
            ...
            e = void 0 !== n[0] ? n[0] : {}, d = e, 0 <= h.filterFunc.indexOf(o) || p(this, "event", o), 
            w && p(this, "yyy", o);
        }
    }
    function M(t, o, e) {
    ...
    r.prototype.pushuserinfo = function(t, o) {
        if ("object" === (void 0 === t ? "undefined" : _typeof(t))) {
            var e = [ "encryptedData", "errMsg", "iv", "rawData", "signature", "userInfo" ];
            for (var n in t) if (e.indexOf(n) < 0) return;
            this.app.aldpush_login_data = t, "string" == typeof o && (v.jscode = o), p(this.app, "user_info", "userinfo");
        }
    }, r.prototype.setopenid = function(t) {
        "string" == typeof t && (this.app.aldpush_openid = t, p(this.app, "setopenid", "setopenid"));
    };
    var D = App;
    App = function(t) {
        M(t, "onLaunch", f), M(t, "onShow", u), M(t, "onHide", g), D(t);
    };
    var j = Page;
    Page = function(t) {
        ...
        M(t, "onShow", _), M(t, "hidepushFormSubmit", k), M(t, "pushFormSubmit", S), j(t);
    };
}();