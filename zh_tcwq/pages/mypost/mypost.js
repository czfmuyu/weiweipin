...
Page({
    ...
    selected: function(e) {
        var t = this, a = e.currentTarget.id, o = wx.getStorageSync("openid"), n = wx.getStorageSync("users").id, s = t.data.stick, i = s[a].money, c = s[a].type, r = this.data.xfid;
        t.setData({
            iszd: !1
        }), console.log(i, c, r), app.util.request({
            url: "entry/wxapp/Pay",
            cachetime: "0",
            data: {
                openid: o,
    ...
    reload: function(e) {
        var i = this, t = wx.getStorageSync("users").id, c = wx.getStorageSync("url"), r = wx.getStorageSync("users").img, l = i.data.page, u = i.data.postlist;
        console.log(r), app.util.request({
            ...
            success: function(e) {
                console.log(e), i.setData({
                    page: l + 1
                }), console.log(e), e.data.length < 10 ? i.setData({
                    refresh_top: !0
                }) : i.setData({
                    refresh_top: !1
                }), u = u.concat(e.data), console.log(u);
                var t = [], a = [], o = [];
                for (var n in e.data) e.data[n].time = i.ormatDate(e.data[n].time).slice(0, 16), 
