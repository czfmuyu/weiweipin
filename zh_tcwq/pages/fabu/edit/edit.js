...
Page({
    ...
    onLoad: function(e) {
        ...
        var a = e.info, n = e.money, s = e.type_id, c = e.type2_id, o = wx.getStorageSync("System");
    ...
    formSubmit: function(e) {
        ...
        if (null == t.data.type) var o = 0; else o = t.data.type;
        ...
        if (1 == k) {
            if (0 == D) {
                ...
                F = 1;
                z = T * N + T * N * (c / 100), _ += Number(z.toFixed(2));
            }
            1 == b ? (A = e.detail.value.welfare_pass, q = 2) : q = 1;
        } else _ = _;
        if ("" == p ? S = "内容不能为空" : 540 <= p.length ? S = "内容超出了" : "" == f ? S = "姓名不能为空" : "" == y ? S = "电话不能为空" : 1 == k && ("" == T ? S = "红包金额不能为空" : !t.data.checked_average && T < 1 ? S = "福利红包金额不能小于1元" : "" == N ? S = "红包个数不能为空" : F < .1 ? S = "红包份数过大，请合理设置" : t.data.checked_average && T < .1 ? S = "单个红包最小金额不能小于0.1元" : 1 == b && ("" == A ? S = "口令不能为空" : C.test(A) || (S = "口令只能输入汉字"))), 
        "" != S) wx.showModal({
            title: "提示",
            content: S,
            success: function(e) {},
            ...
            _ <= 0 ? (t.setData({
                ...
                disabled: !0
            }), console.log(t.data.money, t.data.money1, Number(t.data.money) + Number(t.data.money1)), 
            app.util.request({
                url: "entry/wxapp/Pay",
                cachetime: "0",
                data: {
