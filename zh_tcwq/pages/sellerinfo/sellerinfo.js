...
Page({
    ...
    previewImage: function(t) {
        var e = this, a = e.data.url, i = [], n = e.data.store.weixin_logo;
    ...
    previewImage3: function(t) {
        var e = this, a = e.data.url, i = [], n = e.data.store.ewm_logo;
    ...
    previewImage1: function(t) {
        var e = this.data.url, a = [], i = t.currentTarget.id, n = this.data.store.images;
    ...
    onLoad: function(t) {
        ...
        }), null == t.scene) var a = wx.getStorageSync("users"), i = wx.getStorageSync("users").id, n = t.id; else {
            n = e;
            wx.login({
                success: function(t) {
                    var e = t.code;
    ...
    reload: function(t) {
        ...
        app.util.request({
            ...
            success: function(t) {
                ...
                t.data.store[0].star = r.slice(0, t.data.store[0].score), t.data.pl) t.data.pl[e].star = r;
                ...
                var n = t.data.store[0].details.length * o.data.size, s = wx.getSystemInfoSync().windowWidth;
                console.log(n, s), o.setData({
                    length: n,
                    windowWidth: s
                }), o.scrolltxt();
            }
    ...
    star: function(t) {
        var e = t.currentTarget.dataset.index, a = this.data.star, i = "../image/xing.png", n = "../image/star_none.png";
        0 == e ? (a[0].img = i, a[1].img = n, a[2].img = n, a[3].img = n, a[4].img = n) : 1 == e ? (a[0].img = i, 
        a[1].img = i, a[2].img = n, a[3].img = n, a[4].img = n) : 2 == e ? (a[0].img = i, 
        a[1].img = i, a[2].img = i, a[3].img = n, a[4].img = n) : 3 == e ? (a[0].img = i, 
        a[1].img = i, a[2].img = i, a[3].img = i, a[4].img = n) : 4 == e && (a[0].img = i, 
    ...
    formid_two: function(t) {
        ...
        var e = this, a = e.data.index, i = e.data.value, n = e.data.id, s = wx.getStorageSync("users").id, o = e.data.reflex_id;
            ...
            success: function(t) {
                ...
                app.util.request({
                    ...
                    success: function(t) {
                        ...
                        u <= t.data[n].time ? i.push(t.data[n]) : app.util.request({
    ...
    onShow: function() {},
    scrolltxt: function() {
        var a = this, i = a.data.length, n = a.data.windowWidth, s = setInterval(function() {
            var t = i + n, e = a.data.marqueeDistance;
            e < t ? a.setData({
                marqueeDistance: e + a.data.marqueePace
            }) : (a.setData({
                marqueeDistance: 0
            }), clearInterval(s), a.scrolltxt());
        }, a.data.interval);
    },
    onHide: function() {},
    onUnload: function() {},
