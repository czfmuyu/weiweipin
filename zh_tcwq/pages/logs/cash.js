...
Page({
    ...
    reload: function(e) {
                                    ...
                                    success: function(e) {
                                        ...
                                        app.util.request({
                                            ...
                                            success: function(e) {
                                                ...
                                                n = n.toFixed(2), console.log(n), s.setData({
                                                    money: n
                                                });
                                            }
                                        });
        ...
        var a = wx.getStorageSync("System"), n = a.tx_sxf / 100, o = a.tx_sxf, i = a.tx_money;
        s.setData({
            tx_price: i,
            tx_sxf: n,
            tx_sxf1: o,
    ...
    formSubmit: function(e) {
        ...
        if (u < s) wx.showModal({
            ...
            if (1 == d) {
                ...
                var w = e.detail.value.ylname, p = e.detail.value.ylka, _ = e.detail.value.ylkahao;
